...
from .services import get_resident_or_create, get_new_time_slots, get_overlapping_bookings_list, \
    ...
    check_and_convert_date, convert_to_reversed_date_format
...
class AvailabilitySerializer(serializers.ModelSerializer):
    ...
    def get_start(self, obj):
        return '{} {}'.format(convert_to_reversed_date_format(str(obj.date)), obj.start)

    def get_end(self, obj):
        return '{} {}'.format(convert_to_reversed_date_format(str(obj.date)), obj.end)
...
class BookingCreateSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        date_str = str(check_and_convert_date(date_str))
    ...
    def create(self, validated_data):
        ...
        date = str(check_and_convert_date(date))
        available_time_slot = get_available_time_slot(room, date, start_time, end_time)
